...
namespace IWXMVM::IW2::Addresses
{
    ...
    constexpr uintptr_t CG_DrawDisconnect = 0x004C7AC0;  // int __cdecl(); draws the "Connection Interrupted" text + icon when snapshots stall
    ...
    constexpr uintptr_t cg_cursorHintTime = 0x01519E6C;     // int, cg.time of the latch
    constexpr uintptr_t cg_cursorHintString = 0x01519E74;   // int, configstring index
